...
export const modTemplates: ReadonlyArray<ModTemplate> = [
    ...
    { desc: '#% Increased Skill Duration', tags: ['Skill', 'Duration'], stats: [{ name: 'Duration', valueType: 'Inc', flags: StatModifierFlag.Skill }], },
    ...
    { desc: '+# Maximum Burn Stack', tags: ['Burn', 'Ailment', 'Global', "Elemental"], stats: [{ name: 'AilmentStack', valueType: 'Base', flags: StatModifierFlag.Burn, keywords: KeywordModifierFlag.Global }], },
